...
class Idle:
    ...
    def draw(self):
        sx = self.boy.x - common.court.window_left # 화면상의 x위치
        sy = self.boy.y - common.court.window_bottom # 화면상의 y위치
...
class Boy:
    def __init__(self):
        ...
        # 시작 위치를 코트의 중앙으로 설정
        self.x = common.court.w / 2
        self.y = common.court.h / 2
    ...
    def update(self):
        ...
        self.x = clamp(50.0, self.x, float(common.court.w - 50))
        self.y = clamp(50.0, self.y, float(common.court.h - 50))
